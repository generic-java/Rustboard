var Socket = {
    ...
    sendData: function (data) {
        try {
            ...
            if (Socket.connected) Notify.createNotice("Could not properly connect to the Control Hub", "negative", 5000);
        }
    },
    ...
    openSocket: function (recursion) {
        ...
        try {
            Socket.websocket = new WebSocket("ws://192.168.43.1:21865"/*WhiteboardSettings.websocketURL*/);
        } catch {
        ...
        Socket.websocket.onopen = () => {
            ...
            data.message.messageType = "connection info";
            data.message.id = WhiteboardSettings.dashboardID;
    ...
    handleMessage: function (data) {
        ...
        if (data.messageType === "node update") {
            try {
